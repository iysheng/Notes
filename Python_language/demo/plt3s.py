...
ax.set_title("高温测试")
ax.plot(x3,y3,z3, markerfacecolor='red',marker='x',label="高温测试曲线")
ax.set_xlabel('亮度等级')
ax.set_ylabel('环境温度')
ax.set_zlabel('驱动板温度')
